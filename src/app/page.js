...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-white dark:bg-[#050505] text-gray-900 dark:text-white overflow-hidden font-sans flex flex-col transition-colors duration-300">
      ...
      <nav className="relative z-10 flex justify-between items-center px-6 md:px-12 py-6 bg-black/5 dark:bg-white/5 backdrop-blur-xl border-b border-black/10 dark:border-white/10 transition-colors">
        <Link href="/" className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-gray-900 to-gray-500 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
        ...
        <div className="flex gap-4 md:gap-6 items-center">
          <ThemeToggle />
          <Link href="/login" className="text-sm md:text-base text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium transition-colors">
            Log In
          </Link>
      ...
      <main className="relative z-10 flex-1 flex flex-col justify-center items-center text-center px-4 mt-12 md:mt-16">        
        ...
        <div className="w-full max-w-5xl h-40 md:h-64 mt-auto rounded-t-2xl md:rounded-t-3xl bg-gradient-to-b from-black/5 dark:from-white/10 to-transparent border border-black/10 dark:border-white/10 border-b-0 backdrop-blur-md relative overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_-20px_50px_rgba(0,0,0,0.5)] flex flex-col transition-all">
          ...
          <div className="flex-1 w-full bg-gradient-to-b from-black/5 dark:from-white/5 to-transparent transition-colors"></div>
        </div>
      </main>
    </div>
  );
